...
public class MazeGraph
{
    ...
    private List<MazeGraphCell> _CellsTemp;
    ...
    public List<MazeGraphCell> Cells
    {
        get
        {
            return _CellsTemp;
    ...
    public MazeGraph(W4Maze maze, bool isSimplify)
    {
        ...
        for (int j = 0; j < maze.RowCount; j++)
        {
            for (int i = 0; i < maze.ColumnCount; i++)
            {
                ...
                _Cells[index].Position = new Vector2(i + _Height, j + _Height);
                _Cells[index].W4Cell = cell;
                ...
                if (cell.BotWall)
                {
                    ...
                    edge.Begin = new Vector2(
                        _Cells[index].Position.x - _Height,
                        _Cells[index].Position.y - _Height);
